...
public class VehiclePhysicsWheelCollider : MonoBehaviour
{
    ...
    private GroundMaterials physicsMaterials
    {
        get { return groundMaterials; }
    } // Instance of Configurable Ground Materials.

    private GroundMaterials.GroundMaterialFrictions[] physicsFrictions
    {
        get { return groundMaterials.frictions; }
    }
