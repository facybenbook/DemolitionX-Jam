...
public class VehiclePhysics : MonoBehaviour
{
    ...
    /// </summary>
    [Header("Behaviour Preset")] [Tooltip("How must the vehicle behave?")]
    ...
    [Header("Wheel Type")] public WheelType _wheelTypeChoise = WheelType.RWD;
    ...
    [Header("Wheel Colliders")] public VehiclePhysicsWheelCollider FrontLeftWheelCollider;
    ...
    [Header("Steering")] public Transform SteeringWheel; // Driver Steering Wheel. In case of if your vehicle has individual steering wheel model in interior.
    ...
    [Header("Engine")] public float engineTorque = 2000f; // Default Engine Torque.
    ...
    [Header("Antiroll")] public float antiRollFrontHorizontal = 5000f; // Anti Roll Horizontal Force For Preventing Flip Overs And Stability.
    ...
    [Header("Fuel")] public bool useFuelConsumption = false; // Enable / Disable Fuel Consumption.
    ...
    // Engine heat.
    [Header("Engine Heat")] public bool useEngineHeat = false; // Enable / Disable engine heat.
    ...
    // Gears.
    [Header("Transmission")] public int currentGear = 0; // Current Gear Of The Vehicle.
    ...
    [Header("Audio System")] public AudioType audioType;
    ...
    {
        get { return commonSettings.gearShiftingClips; }
    }
    ...
    {
        get { return commonSettings.crashClips; }
    }
    ...
    {
        get { return commonSettings.reversingClip; }
    }
    ...
    {
        get { return commonSettings.windClip; }
    }
    ...
    {
        get { return commonSettings.brakeClip; }
    }
    ...
    {
        get { return commonSettings.NOSClip; }
    }
    ...
    {
        get { return commonSettings.turboClip; }
    }
    ...
    {
        get { return steerInput + _counterSteerInput; }
    }
    ...
    [Header("Chassis")] public GameObject chassis; // Script will simulate chassis movement based on vehicle rigidbody velocity.
    ...
    {
        get { return commonSettings.engineSmoke.GetComponent<ParticleSystem>(); }
    }
    ...
    [Header("Driving Assistances")] public bool ABS = true;
    ...
    [Header("Turbo and NOS")] public bool useNOS = false;
    ...
    [Header("Generated")] public AnimationCurve[] engineTorqueCurve;
